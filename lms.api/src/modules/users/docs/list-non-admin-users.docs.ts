...
export const ListNonAdminUsersDocs = () =>
  applyDecorators(
    ApiCookieAuth('access_token'),
    ApiOperation({
      summary: 'List teachers and students (admin)',
      description:
        'Returns only users with role teacher or student. Admins are excluded.',
    }),
    ...
    ApiResponse({
      status: 200,
      description: 'Paginated list of non-admin users',
      schema: {
        type: 'object',
        properties: {
          data: {
